...
-- ----------------------------
INSERT INTO `app_application` VALUES (20, 's3-api', 's3-api', 60, 2, 's3-api', 'https://github.com/zhang1024fan/deviops', '[107]', '[106]', '[89]', 'Java', '', '', '', '[\"www.example.com\"]', '[1]', '[2]', '{}', 2, '2026-01-19 15:55:00.906', '2026-01-19 15:55:47.509', NULL);
...
INSERT INTO `app_sh_release` VALUES (7, '测试002', '测试002', 12, 19, 'prod_saas3.0_data-export', 'prod-saas30-data-export', 1, '管理员', 89, '管理员', 89, '管理员', '/home/dingding/saas3-data-export/', 'hostname -I', 2, '2025-12-25 11:36:50.014', 'ok', 6, 2, '2025-12-25 11:39:15.664', '2025-12-25 11:39:17.092', 0, 51, 11, 'http://test-ops-jenkins-tc2.dding.net:8080/job/prod_saas3.0_data-export/11/console', '', '2025-12-25 11:36:31.470', '2025-12-25 11:39:17.147', NULL, '{\"commit_id\":\"123456789\"}', 506, '2025-12-25 11:37:37.238', '2025-12-25 11:37:49.711', '203.0.113.10 203.0.113.10 203.0.113.10 \n');
...
-- ----------------------------
INSERT INTO `cmdb_sql_records` VALUES (1, '203.0.113.10:3306', 'gin-api', 'SELECT', 'select * from cmdb_group;', 'anonymous', 14, 0, 403, 14, 'SUCCESS', '2025-07-29 11:14:13.686', '');
INSERT INTO `cmdb_sql_records` VALUES (2, '203.0.113.10', 'saas3-mysql', 'SELECT', 'select * from cmdb_group;', '', 0, 0, 50, 10, 'SUCCESS', '2025-07-30 13:29:24.409', '');
INSERT INTO `cmdb_sql_records` VALUES (3, '203.0.113.10', 'gin-api', 'SELECT', 'select * from cmdb_group;', '', 0, 0, 54, 14, 'SUCCESS', '2025-07-30 13:58:13.386', '');
INSERT INTO `cmdb_sql_records` VALUES (4, '203.0.113.10', 'saas3-mysql', 'INSERT', 'UPDATE `cmdb_group`SET `name` = \'sql测试组0000\' WHERE `parent_id` = 17AND `name` = \'sql测试组\';', '', 0, 1, 80, 0, 'SUCCESS', '2025-07-30 14:00:44.370', '');
INSERT INTO `cmdb_sql_records` VALUES (5, '203.0.113.10', 'saas3-mysql', 'INSERT', 'UPDATE `cmdb_group` SET `name` = \'test123\' WHERE `id` = 22;', '', 0, 1, 80, 0, 'SUCCESS', '2025-07-30 14:04:30.684', '');
INSERT INTO `cmdb_sql_records` VALUES (6, '203.0.113.10', 'saas3-mysql', 'INSERT', 'UPDATE `cmdb_group` SET `name` = \'test123111\' WHERE `id` = 22;', '', 0, 1, 80, 0, 'SUCCESS', '2025-07-30 14:06:34.692', '');
INSERT INTO `cmdb_sql_records` VALUES (7, '203.0.113.10', 'gin-api', 'SELECT', 'UPDATE `cmdb_group` SET `name` = \'test123111\' WHERE `id` = 22;', '', 0, 0, 122, 0, 'SUCCESS', '2025-07-30 14:07:44.151', '');
INSERT INTO `cmdb_sql_records` VALUES (8, '203.0.113.10', 'gin-api', 'SELECT', 'UPDATE `cmdb_group` SET `name` = \'test001\' WHERE `id` = 22;', '', 0, 0, 55, 0, 'SUCCESS', '2025-07-30 14:11:42.626', '');
INSERT INTO `cmdb_sql_records` VALUES (9, '203.0.113.10', 'gin-api', 'SELECT', 'select * from cmdb_group;', '', 0, 0, 67, 15, 'SUCCESS', '2025-07-30 15:24:57.109', '');
INSERT INTO `cmdb_sql_records` VALUES (10, '203.0.113.10', 'gin-api', 'SELECT', 'select * from cmdb_host;', '', 0, 0, 114, 75, 'SUCCESS', '2025-07-30 15:25:19.542', '');
INSERT INTO `cmdb_sql_records` VALUES (11, '203.0.113.10', 'gin-api', 'SELECT', 'select * from cmdb_group;', '', 0, 0, 56, 15, 'SUCCESS', '2025-07-30 15:29:16.507', '');
INSERT INTO `cmdb_sql_records` VALUES (12, '203.0.113.10', 'saas3-mysql', 'EXECUTE', 'create databases  db;', '', 0, 1, 100, 0, 'SUCCESS', '2025-07-30 15:34:31.246', '');
INSERT INTO `cmdb_sql_records` VALUES (13, '203.0.113.10', 'gin-api', 'SELECT', 'select id,name from cmdb_group;', '', 0, 0, 51, 15, 'SUCCESS', '2025-07-30 17:18:52.168', '');
INSERT INTO `cmdb_sql_records` VALUES (14, '203.0.113.10', 'gin-api', 'SELECT', 'select id,name from cmdb_group;', '', 0, 0, 53, 15, 'SUCCESS', '2025-07-30 17:29:36.465', '');
INSERT INTO `cmdb_sql_records` VALUES (15, '203.0.113.10', 'gin-api', 'SELECT', 'select id,name from  cmdb_group;', '', 0, 0, 56, 15, 'SUCCESS', '2025-07-30 21:06:07.136', '');
INSERT INTO `cmdb_sql_records` VALUES (16, '203.0.113.10', 'gin-api', 'SELECT', 'select id,name from  cmdb_group;', '', 0, 0, 64, 15, 'SUCCESS', '2025-07-30 21:12:04.886', '');
INSERT INTO `cmdb_sql_records` VALUES (17, '203.0.113.10', 'gin-api', 'SELECT', 'select id,name from  cmdb_group;', 'admin', 0, 0, 51, 15, 'SUCCESS', '2025-07-30 21:23:55.532', '');
INSERT INTO `cmdb_sql_records` VALUES (18, '203.0.113.10', 'gin-api', 'SELECT', 'select id,name from  cmdb_group;', 'zhangsan', 0, 0, 54, 15, 'SUCCESS', '2025-07-30 21:26:51.642', '');
...
-- ----------------------------
INSERT INTO `config_account` VALUES (16, 'http://203.0.113.10:8080/', 'http://203.0.113.10:8080/', 0, 'root', 'H18lFhT4+TPwwzwy8gdn2Wyqz13Z8JRNahNWHeU0Ens=', 4, '123', '2026-01-18 23:25:59.170', '2026-01-18 23:25:59.170');
...
INSERT INTO `db_sql_exec` VALUES (251, 2, 'database_name', 'users', 2, 'INSERT INTO users (name, email) VALUES (\'张三\', \'redacted@example.com\')', '', '', 1, '执行成功', 376, '2025-11-30 01:11:20.911', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (286, 2, 'database_name', 'users', 2, 'INSERT INTO users (name, email) VALUES (\'李四\', \'redacted@example.com\')', '', '', 1, '执行成功', 285, '2025-12-01 00:00:30.571', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (296, 1, 'devops', 'cmdb_host', 3, 'UPDATE cmdb_host SET host_name = \'虚拟机001111\', group_id = 12, private_ip = \'203.0.113.10\', public_ip = \'203.0.113.10\', ssh_name = \'root\', ssh_key_id = 13, ssh_port = 22, remark = \'123\', vendor = 1, region = \'\', instance_id = \'\', os = \'CentOSLinux7(Core)\', status = 1, cpu = \'2\', memory = \'4\', disk = \'17\', billing_type = \'\', create_time = \'2025-11-23 23:44:35\', expire_time = NULL, update_time = \'2025-11-23 23:45:32\', ssh_ip = \'203.0.113.10\', name = \'jenkins\', ssh_gateway_id = NULL WHERE id = 511;', '', '', 1, '执行成功', 254, '2025-12-01 00:20:08.106', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (306, 2, 'database_name', 'users', 2, 'INSERT INTO users (name, email) VALUES (\'test\', \'redacted@example.com\')', '', '', 1, '执行成功', 553, '2025-12-01 00:30:03.796', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (317, 1, 'devops', 'cmdb_host', 3, 'UPDATE cmdb_host SET host_name = \'虚拟机01\', group_id = 12, private_ip = \'203.0.113.10\', public_ip = \'203.0.113.10\', ssh_name = \'root\', ssh_key_id = 13, ssh_port = 22, remark = \'123\', vendor = 1, region = \'\', instance_id = \'\', os = \'CentOSLinux7(Core)\', status = 1, cpu = \'2\', memory = \'4\', disk = \'17\', billing_type = \'\', create_time = \'2025-11-23 23:44:35\', expire_time = NULL, update_time = \'2025-11-23 23:45:32\', ssh_ip = \'203.0.113.10\', name = \'jenkins\', ssh_gateway_id = NULL WHERE id = 511;', '', '', 1, '执行成功', 722, '2025-12-01 00:44:23.250', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (335, 2, 'database_name', 'students', 2, 'INSERT INTO students (student_id, name, gender, birth_date, email, phone, enrollment_date, major) VALUES (\'1\', \'张三\', \'m\', \'2004-05-15\', \'redacted@example.com\', \'12345678911\', \'2004-05-15\', \'软件工程\')', '', '', 2, 'pq: new row for relation \"students\" violates check constraint \"students_gender_check\"', 186, '2025-12-01 00:52:04.216', '', 0);
INSERT INTO `db_sql_exec` VALUES (336, 2, 'database_name', 'students', 2, 'INSERT INTO students (student_id, name, gender, birth_date, email, phone, enrollment_date, major) VALUES (\'20230001\', \'张三\', \'m\', \'2004-05-15\', \'redacted@example.com\', \'13800000000\', \'2004-05-15\', \'软件工程\')', '', '', 2, 'pq: new row for relation \"students\" violates check constraint \"students_gender_check\"', 182, '2025-12-01 00:52:31.225', '', 0);
INSERT INTO `db_sql_exec` VALUES (337, 2, 'database_name', 'students', 2, 'INSERT INTO students (student_id, name, gender, birth_date, email, phone, enrollment_date, major) VALUES (\'20230001\', \'张三\', \'\'\'M\'\'\', \'2004-05-15\', \'redacted@example.com\', \'13800000000\', \'2004-05-15\', \'软件工程\')', '', '', 2, 'pq: value too long for type character(1)', 214, '2025-12-01 00:52:54.401', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (339, 2, 'database_name', 'users', 2, 'INSERT INTO users (name, email) VALUES (\'test123\', \'redacted@example.com\')', '', '', 1, '执行成功', 183, '2025-12-01 00:53:22.992', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (389, 1, 'devops', 'cmdb_host_1', 2, 'INSERT INTO cmdb_host_1 (id, host_name, group_id, private_ip, public_ip, ssh_name, ssh_key_id, ssh_port, remark, vendor, region, instance_id, os, status, cpu, memory, disk, billing_type, create_time, expire_time, update_time, ssh_ip, name, ssh_gateway_id) VALUES (506, \'华为云ops\', 4, \'203.0.113.10\', \'203.0.113.10\', \'root\', 22, 22, \'123\', 5, \'\', \'\', \'Ubuntu24.04.2\', 1, \'2\', \'2\', \'40\', \'\', \'2025-11-11 17:24:36\', NULL, \'2025-11-26 17:22:07\', \'203.0.113.10\', \'hw-ops\', NULL);', '', '', 2, 'Error 1146 (42S02): Table \'devops.cmdb_host_1\' doesn\'t exist', 202, '2025-12-03 10:43:12.842', '', 0);
INSERT INTO `db_sql_exec` VALUES (390, 1, 'devops', 'cmdb_host_1', 2, 'INSERT INTO cmdb_host_1 (id, host_name, group_id, private_ip, public_ip, ssh_name, ssh_key_id, ssh_port, remark, vendor, region, instance_id, os, status, cpu, memory, disk, billing_type, create_time, expire_time, update_time, ssh_ip, name, ssh_gateway_id) VALUES (506, \'华为云ops\', 4, \'203.0.113.10\', \'203.0.113.10\', \'root\', 22, 22, \'123\', 5, \'\', \'\', \'Ubuntu24.04.2\', 1, \'2\', \'2\', \'40\', \'\', \'2025-11-11 17:24:36\', NULL, \'2025-11-26 17:22:07\', \'203.0.113.10\', \'hw-ops\', NULL);', '', '', 2, 'Error 1146 (42S02): Table \'devops.cmdb_host_1\' doesn\'t exist', 216, '2025-12-03 10:43:14.148', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (435, 1, 'devops', 'cmdb_host', 3, 'UPDATE cmdb_host SET host_name = \'虚拟机2025\', group_id = 4, private_ip = \'203.0.113.10\', public_ip = \'203.0.113.10\', ssh_name = \'root\', ssh_key_id = 13, ssh_port = 22, remark = \'123\', vendor = 1, region = \'\', instance_id = \'\', os = \'Ubuntu20.04.2\', status = 1, cpu = \'2\', memory = \'3\', disk = \'19\', billing_type = \'\', create_time = \'2025-11-23 23:46:03\', expire_time = NULL, update_time = \'2025-11-23 23:46:07\', ssh_ip = \'203.0.113.10\', name = \'k8s-node02\', ssh_gateway_id = NULL WHERE id = 512;', '', '', 1, '执行成功', 436, '2025-12-05 20:34:45.595', '', 0);
...
INSERT INTO `db_sql_exec` VALUES (441, 2, 'database_name', 'users', 2, 'INSERT INTO users (name, email) VALUES (\'王五\', \'redacted@example.com\')', '', '', 1, '执行成功', 191, '2025-12-05 20:37:14.770', '', 0);
...
-- ----------------------------
INSERT INTO `monitor_aliyun_config` VALUES (2, 'example-aliyun-dns', 'REDACTED_ACCESS_KEY', 'REDACTED_ACCESS_SECRET', '', 'redacted@example.com', '13800000000', 'public-demo', 1, '2026-01-17 14:19:54.333', '2026-01-18 23:48:35.636', '', '');
...
-- ----------------------------
INSERT INTO `monitor_ssl_cert` VALUES (17, 'example.com', 2, '', 0, 'cert-example-com-redacted', 'public-placeholder', 3, 'DNS', '', 'REDACTED_CERTIFICATE_CHAIN_FOR_PUBLIC_REPO', 'REDACTED_PRIVATE_KEY_FOR_PUBLIC_REPO', '2026-01-17 08:00:00.000', '2026-04-17 08:00:00.000', 1, '', '2026-01-17 14:21:03.143', '2026-01-17 14:21:18.381', 'manual', 'Sanitized Example', '', 'RSA2048');
INSERT INTO `monitor_ssl_cert` VALUES (20, 'example.org', 2, '', 0, 'cert-example-org-redacted', 'public-placeholder', 3, 'DNS', '', 'REDACTED_CERTIFICATE_CHAIN_FOR_PUBLIC_REPO', 'REDACTED_PRIVATE_KEY_FOR_PUBLIC_REPO', '2026-01-17 08:00:00.000', '2026-04-16 08:00:00.000', 1, '', '2026-01-17 15:20:53.046', '2026-01-17 15:28:00.659', 'manual', 'Sanitized Example', '', 'RSA2048');
...
-- ----------------------------
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (1, 6, 'example.com', 525, 'example-host', '/etc/nginx/ssl', 3, '[]', '[]', '[]', '获取SSH认证信息失败: Error 1054 (42S22): Unknown column \'auth\' in \'field list\'', '2025-12-17 12:20:35', '2025-12-17 12:20:35');
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (2, 6, 'example.com', 525, 'example-host', '/etc/nginx/ssl', 2, '[]', '[\"/etc/nginx/ssl/example.com.pem\",\"/etc/nginx/ssl/example.com.key\"]', '[\"[2025-12-17 12:26:56] 开始部署证书到主机: example-host (203.0.113.10)\",\"[2025-12-17 12:26:56] 检查部署目录: /etc/nginx/ssl\",\"[2025-12-17 12:26:59] 目录已就绪\",\"[2025-12-17 12:26:59] 检查旧证书文件\",\"[2025-12-17 12:27:02] 开始部署新证书\",\"[2025-12-17 12:27:03] 证书文件已部署: /etc/nginx/ssl/example.com.pem\",\"[2025-12-17 12:27:04] 私钥文件已部署: /etc/nginx/ssl/example.com.key\",\"[2025-12-17 12:27:05] 已设置文件权限为 600\",\"[2025-12-17 12:27:05] 开始重载Nginx\",\"[2025-12-17 12:27:07] Nginx重载成功\",\"[2025-12-17 12:27:07] Nginx输出: 2025/12/17 12:27:07 [notice] 356917#356917: signal process started\",\"[2025-12-17 12:27:07] 证书部署完成\"]', '', '2025-12-17 12:26:57', '2025-12-17 12:27:07');
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (3, 1, 'example.com', 525, 'example-host', '/etc/nginx/ssl', 2, '[\"/etc/nginx/ssl/example.com.pem.20251217130203.bak\",\"/etc/nginx/ssl/example.com.key.20251217130203.bak\"]', '[\"/etc/nginx/ssl/example.com.pem\",\"/etc/nginx/ssl/example.com.key\"]', '[\"[2025-12-17 13:02:00] 开始部署证书到主机: example-host (203.0.113.10)\",\"[2025-12-17 13:02:00] 检查部署目录: /etc/nginx/ssl\",\"[2025-12-17 13:02:03] 目录已就绪\",\"[2025-12-17 13:02:03] 检查旧证书文件\",\"[2025-12-17 13:02:05] 已备份证书文件: /etc/nginx/ssl/example.com.pem.20251217130203.bak\",\"[2025-12-17 13:02:08] 已备份密钥文件: /etc/nginx/ssl/example.com.key.20251217130203.bak\",\"[2025-12-17 13:02:08] 开始部署新证书\",\"[2025-12-17 13:02:09] 证书文件已部署: /etc/nginx/ssl/example.com.pem\",\"[2025-12-17 13:02:10] 私钥文件已部署: /etc/nginx/ssl/example.com.key\",\"[2025-12-17 13:02:11] 已设置文件权限为 600\",\"[2025-12-17 13:02:11] 开始重载Nginx\",\"[2025-12-17 13:02:13] Nginx重载成功\",\"[2025-12-17 13:02:13] Nginx输出: 2025/12/17 13:02:13 [notice] 359465#359465: signal process started\",\"[2025-12-17 13:02:13] 证书部署完成\"]', '', '2025-12-17 13:02:00', '2025-12-17 13:02:13');
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (4, 7, 'example.com', 525, 'example-host', '/etc/nginx/ssl', 2, '[\"/etc/nginx/ssl/example.com.pem.20251217140432.bak\",\"/etc/nginx/ssl/example.com.key.20251217140432.bak\"]', '[\"/etc/nginx/ssl/example.com.pem\",\"/etc/nginx/ssl/example.com.key\"]', '[\"[2025-12-17 14:04:29] 开始部署证书到主机: example-host (203.0.113.10)\",\"[2025-12-17 14:04:29] 检查部署目录: /etc/nginx/ssl\",\"[2025-12-17 14:04:32] 目录已就绪\",\"[2025-12-17 14:04:32] 检查旧证书文件\",\"[2025-12-17 14:04:34] 已备份证书文件: /etc/nginx/ssl/example.com.pem.20251217140432.bak\",\"[2025-12-17 14:04:37] 已备份密钥文件: /etc/nginx/ssl/example.com.key.20251217140432.bak\",\"[2025-12-17 14:04:37] 开始部署新证书\",\"[2025-12-17 14:04:37] 检测到证书已包含完整链\",\"[2025-12-17 14:04:38] 证书文件已部署: /etc/nginx/ssl/example.com.pem\",\"[2025-12-17 14:04:39] 私钥文件已部署: /etc/nginx/ssl/example.com.key\",\"[2025-12-17 14:04:41] 已设置文件权限为 600\",\"[2025-12-17 14:04:41] 开始重载Nginx\",\"[2025-12-17 14:04:42] Nginx重载成功\",\"[2025-12-17 14:04:42] Nginx输出: 2025/12/17 14:04:42 [notice] 363589#363589: signal process started\",\"[2025-12-17 14:04:42] 证书部署完成\"]', '', '2025-12-17 14:04:29', '2025-12-17 14:04:42');
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (5, 8, 'example.com', 525, 'example-host', '/etc/nginx/ssl', 2, '[\"/etc/nginx/ssl/example.com.pem.20251217154631.bak\",\"/etc/nginx/ssl/example.com.key.20251217154631.bak\"]', '[\"/etc/nginx/ssl/example.com.pem\",\"/etc/nginx/ssl/example.com.key\"]', '[\"[2025-12-17 15:46:28] 开始部署证书到主机: example-host (203.0.113.10)\",\"[2025-12-17 15:46:28] 检查部署目录: /etc/nginx/ssl\",\"[2025-12-17 15:46:31] 目录已就绪\",\"[2025-12-17 15:46:31] 检查旧证书文件\",\"[2025-12-17 15:46:34] 已备份证书文件: /etc/nginx/ssl/example.com.pem.20251217154631.bak\",\"[2025-12-17 15:46:36] 已备份密钥文件: /etc/nginx/ssl/example.com.key.20251217154631.bak\",\"[2025-12-17 15:46:36] 开始部署新证书\",\"[2025-12-17 15:46:36] 检测到证书已包含完整链\",\"[2025-12-17 15:46:37] 证书文件已部署: /etc/nginx/ssl/example.com.pem\",\"[2025-12-17 15:46:38] 私钥文件已部署: /etc/nginx/ssl/example.com.key\",\"[2025-12-17 15:46:40] 已设置文件权限为 600\",\"[2025-12-17 15:46:40] 开始重载Nginx\",\"[2025-12-17 15:46:41] Nginx重载成功\",\"[2025-12-17 15:46:41] Nginx输出: 2025/12/17 15:46:41 [notice] 369478#369478: signal process started\",\"[2025-12-17 15:46:41] 证书部署完成\"]', '', '2025-12-17 15:46:29', '2025-12-17 15:46:41');
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (6, 10, 'example.com', 525, 'example-host', '/etc/nginx/ssl', 2, '[\"/etc/nginx/ssl/example.com.pem.20251220153616.bak\",\"/etc/nginx/ssl/example.com.key.20251220153616.bak\"]', '[\"/etc/nginx/ssl/example.com.pem\",\"/etc/nginx/ssl/example.com.key\"]', '[\"[2025-12-20 15:36:15] 开始部署证书到主机: example-host (203.0.113.10)\",\"[2025-12-20 15:36:15] 检查部署目录: /etc/nginx/ssl\",\"[2025-12-20 15:36:16] 目录已就绪\",\"[2025-12-20 15:36:16] 检查旧证书文件\",\"[2025-12-20 15:36:19] 已备份证书文件: /etc/nginx/ssl/example.com.pem.20251220153616.bak\",\"[2025-12-20 15:36:21] 已备份密钥文件: /etc/nginx/ssl/example.com.key.20251220153616.bak\",\"[2025-12-20 15:36:21] 开始部署新证书\",\"[2025-12-20 15:36:21] 检测到证书已包含完整链\",\"[2025-12-20 15:36:22] 证书文件已部署: /etc/nginx/ssl/example.com.pem\",\"[2025-12-20 15:36:23] 私钥文件已部署: /etc/nginx/ssl/example.com.key\",\"[2025-12-20 15:36:25] 已设置文件权限为 600\",\"[2025-12-20 15:36:25] 开始重载Nginx\",\"[2025-12-20 15:36:26] Nginx重载成功\",\"[2025-12-20 15:36:26] Nginx输出: 2025/12/20 15:36:26 [notice] 451483#451483: signal process started\",\"[2025-12-20 15:36:26] 证书部署完成\"]', '', '2025-12-20 15:36:15', '2025-12-20 15:36:26');
INSERT INTO `monitor_ssl_cert_deploy_log` VALUES (7, 17, 'example.com', 1, '阿里云-ops', '/etc/nginx/ssl', 2, '[\"/etc/nginx/ssl/example.com.pem.20260117143010.bak\",\"/etc/nginx/ssl/example.com.key.20260117143010.bak\"]', '[\"/etc/nginx/ssl/example.com.pem\",\"/etc/nginx/ssl/example.com.key\"]', '[\"[2026-01-17 14:30:08] 开始部署证书到主机: 阿里云-ops (203.0.113.10)\",\"[2026-01-17 14:30:08] 检查部署目录: /etc/nginx/ssl\",\"[2026-01-17 14:30:10] 目录已就绪\",\"[2026-01-17 14:30:10] 检查旧证书文件\",\"[2026-01-17 14:30:13] 已备份证书文件: /etc/nginx/ssl/example.com.pem.20260117143010.bak\",\"[2026-01-17 14:30:15] 已备份密钥文件: /etc/nginx/ssl/example.com.key.20260117143010.bak\",\"[2026-01-17 14:30:15] 开始部署新证书\",\"[2026-01-17 14:30:15] 检测到证书已包含完整链\",\"[2026-01-17 14:30:16] 证书文件已部署: /etc/nginx/ssl/example.com.pem\",\"[2026-01-17 14:30:17] 私钥文件已部署: /etc/nginx/ssl/example.com.key\",\"[2026-01-17 14:30:18] 已设置文件权限为 600\",\"[2026-01-17 14:30:18] 开始重载Nginx\",\"[2026-01-17 14:30:19] Nginx重载成功\",\"[2026-01-17 14:30:19] Nginx输出: 2026/01/17 14:30:19 [notice] 486589#486589: signal process started\",\"[2026-01-17 14:30:19] 证书部署完成\"]', '', '2026-01-17 14:30:08', '2026-01-17 14:30:19');
...
-- ----------------------------
INSERT INTO `prompt_template` VALUES (1, 'inspection_summary', 'inspection', 'summary', '你是 OpsNexus 平台中的资深运维巡检助手，请基于主机、Kubernetes、数据库、证书或中间件的巡检结果生成可执行总结。\n\n## 巡检对象\n- 目标类型: {{targetType}}\n- 主机/目标名称: {{hostName}}\n- 目标地址: {{hostIp}}\n- 集群: {{clusterName}}\n- 命名空间: {{namespace}}\n- 工作负载/服务: {{resourceName}}\n- 巡检时间: {{inspectionTime}}\n\n## 汇总指标\n- 总检查项: {{totalChecks}}\n- 通过项: {{passedChecks}}\n- 失败项: {{failedChecks}}\n- 警告项: {{warnChecks}}\n- 事件摘要: {{eventSummary}}\n- 告警摘要: {{alertSummary}}\n\n## 原始结果\n{{checkResults}}\n\n## 输出要求\n1. 先给出总体健康结论，限定为“健康 / 关注 / 异常 / 严重”四档。\n2. 按 P1 / P2 / P3 优先级列出问题，说明直接证据、影响范围和可能的连锁风险。\n3. 给出 3 到 5 条最值得立即执行的动作，优先覆盖日志、事件、YAML、伸缩、证书、回滚或通知。\n4. 如果信息不足，单独列出“仍需补充的数据”。\n5. 最后输出一个验证清单，每条以 - [ ] 开头，便于值班人员逐项确认。\n\n要求：\n- 不重复堆砌原始指标\n- 结论必须可落地\n- 不编造不存在的数据或结论', '["targetType","hostName","hostIp","clusterName","namespace","resourceName","inspectionTime","totalChecks","passedChecks","failedChecks","warnChecks","eventSummary","alertSummary","checkResults"]', '你是 OpsNexus 的巡检与可观测性分析助手，擅长把巡检、日志、事件与告警信息收敛成优先级明确的执行结论。', 0.30, 1800, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
INSERT INTO `prompt_template` VALUES (2, 'incident_analysis', 'incident', 'analysis', '你是 OpsNexus 中的 SRE 故障分析专家，需要结合主机、Kubernetes、数据库、日志、事件、变更和审计信息完成根因分析。\n\n## 故障上下文\n- 目标类型: {{targetType}}\n- 主机: {{hostName}} ({{hostIp}})\n- 集群: {{clusterName}}\n- 命名空间: {{namespace}}\n- 工作负载/Pod/服务: {{resourceName}}\n- 故障类别: {{category}}\n- 检测时间: {{detectTime}}\n- 最近变更: {{recentChanges}}\n- 症状: {{symptoms}}\n\n## 证据数据\n{{evidenceData}}\n\n## 分析约束\n- 优先基于证据，不要凭空猜测。\n- 若证据不足，必须明确指出缺口和下一步采集方法。\n- 如涉及 K8s，请重点检查事件、容器重启、探针、镜像、资源限制、网络、存储、YAML 变更、HPA/伸缩和 RBAC。\n- 如涉及主机或数据库，请重点检查 CPU、内存、磁盘、端口、连接数、慢 SQL、证书和告警历史。\n- 修复建议必须区分“止血动作”和“根治动作”。\n\n请按以下 JSON 返回：\n{\n  "summary": "一句话结论",\n  "rootCause": "最可能的根因",\n  "confidence": "high|medium|low",\n  "keyEvidence": ["证据1", "证据2"],\n  "impact": {\n    "scope": "影响范围",\n    "severity": "P1|P2|P3|P4",\n    "affectedServices": ["服务A"]\n  },\n  "immediateActions": ["止血动作"],\n  "repairPlan": ["根治动作"],\n  "rollbackPlan": ["回滚方案"],\n  "verification": ["验证步骤"],\n  "fixScript": "可执行修复脚本；如不适用返回空字符串",\n  "riskLevel": 0,\n  "riskReason": "风险说明",\n  "missingData": ["仍需补充的数据"]\n}', '["targetType","hostName","hostIp","clusterName","namespace","resourceName","category","detectTime","recentChanges","symptoms","evidenceData"]', '你是 OpsNexus 的故障根因分析助手，要求先证据后结论，兼顾止血、回滚、验证和自动修复风险评估。', 0.20, 2500, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
INSERT INTO `prompt_template` VALUES (3, 'prediction_suggestion', 'prediction', 'suggestion', '你是 OpsNexus 中的容量与弹性规划助手，负责为主机、集群、工作负载和数据库提供扩缩容与成本优化建议。\n\n## 目标信息\n- 目标类型: {{targetType}}\n- 目标: {{targetName}}\n- 集群: {{clusterName}}\n- 命名空间: {{namespace}}\n- 工作负载: {{resourceName}}\n- 指标: {{metricName}} ({{metricType}})\n- 当前值: {{currentValue}}%\n- 阈值: {{threshold}}%\n\n## 趋势信息\n- 趋势类型: {{trendType}}\n- 变化率: {{changeRate}}%/天\n- 预测剩余天数: {{daysLeft}}天\n- 置信度: {{confidence}}%\n- requests/limits: {{resourceSpec}}\n- 当前副本/HPA: {{scalingState}}\n- 未来预测: {{predictions}}\n\n## 输出要求\n1. 判断当前容量状态：充足 / 紧张 / 高风险。\n2. 给出短期建议（24h 到 7d）和中期建议（7d 到 30d）。\n3. 如果对象是 K8s 工作负载，给出 HPA、KEDA、VPA 或手动扩缩容建议，并说明触发指标。\n4. 如果对象是主机或数据库，给出扩容、清理、分片、缓存、连接池、证书或任务迁移建议。\n5. 说明成本与稳定性的取舍。\n6. 最后输出 JSON：\n{\n  "riskLevel": "low|medium|high",\n  "recommendedActions": [\n    {"priority": "P1", "action": "动作", "reason": "原因", "expectedEffect": "预期收益"}\n  ],\n  "recommendedPolicy": {\n    "type": "none|manual-scale|hpa|keda|vpa",\n    "minReplicas": "",\n    "maxReplicas": "",\n    "metric": "",\n    "targetUtilization": ""\n  },\n  "watchMetrics": ["需要持续观察的指标"],\n  "followUpWindow": "建议复查窗口"\n}', '["targetType","targetName","clusterName","namespace","resourceName","metricName","metricType","currentValue","threshold","trendType","changeRate","daysLeft","confidence","resourceSpec","scalingState","predictions"]', '你是 OpsNexus 的容量规划与自动扩缩容建议助手，擅长把趋势预测转换为 HPA、KEDA、VPA 和成本优化动作。', 0.35, 2200, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
INSERT INTO `prompt_template` VALUES (4, 'k8s_event_analysis', 'incident', 'analysis', '你是 OpsNexus 的 Kubernetes 诊断助手，请根据事件、日志、YAML 和资源状态定位 Pod、Deployment、StatefulSet、DaemonSet、Job 或 CronJob 的异常原因。\n\n## K8s 上下文\n- 集群: {{clusterName}}\n- 命名空间: {{namespace}}\n- 资源类型: {{resourceKind}}\n- 资源名称: {{resourceName}}\n- 关联 Pod: {{podName}}\n- 事件时间窗口: {{timeRange}}\n\n## 资源状态\n- 状态摘要: {{statusSummary}}\n- 最近事件: {{eventSummary}}\n- 日志摘要: {{recentLogs}}\n- YAML 摘要: {{yamlSnippet}}\n- 监控摘要: {{metricSummary}}\n\n## 输出要求\n1. 判断问题属于镜像、探针、调度、网络、存储、权限、配置、资源不足、发布变更或外部依赖中的哪一类。\n2. 给出最可能根因和支撑证据。\n3. 提供 kubectl / YAML / 回滚 / 扩缩容四类建议动作。\n4. 明确哪些动作适合 dry-run 或 server-side apply 先验证。\n5. 如果需要人工介入，指出责任角色（平台、应用、DBA、网络、安全）。', '["clusterName","namespace","resourceKind","resourceName","podName","timeRange","statusSummary","eventSummary","recentLogs","yamlSnippet","metricSummary"]', '你是 OpsNexus 的 Kubernetes 事件与发布诊断助手，擅长结合事件、日志、YAML 和监控信息定位容器平台问题。', 0.25, 1800, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
INSERT INTO `prompt_template` VALUES (5, 'alert_triage', 'incident', 'analysis', '你是 OpsNexus 的告警分诊助手，需要对主机、数据库、Kubernetes、SSL 证书或中间件告警进行快速研判和处置建议输出。\n\n## 告警信息\n- 来源类型: {{alertSource}}\n- 告警名称: {{alertName}}\n- 告警级别: {{alertLevel}}\n- 当前状态: {{alertStatus}}\n- 目标对象: {{targetName}}\n- 集群/命名空间: {{clusterName}} / {{namespace}}\n- Labels: {{labels}}\n- Annotations: {{annotations}}\n- 最近变更: {{recentChanges}}\n\n## 指标与历史\n- 指标快照: {{metricSnapshot}}\n- 告警历史: {{alertHistory}}\n- 关联日志/事件: {{eventAndLogSummary}}\n\n## 输出要求\n1. 判断告警是否需要立即升级，输出“立即处理 / 继续观察 / 可静默”三档结论。\n2. 给出前 3 个最可能原因及各自置信度。\n3. 生成值班同学的首轮排查步骤。\n4. 给出通知建议：通知对象、通知渠道、是否需要升级到电话或机器人。\n5. 如果告警与证书、容量、发布变更或 HPA 有关，必须显式指出。', '["alertSource","alertName","alertLevel","alertStatus","targetName","clusterName","namespace","labels","annotations","recentChanges","metricSnapshot","alertHistory","eventAndLogSummary"]', '你是 OpsNexus 的告警分诊与通知助手，擅长对 AlertManager、主机告警、数据库告警和 SSL 告警做优先级判断与升级建议。', 0.20, 1600, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
INSERT INTO `prompt_template` VALUES (6, 'terminal_audit_review', 'general', 'analysis', '你是 OpsNexus 的终端审计分析助手，请对一次 SSH、Kubectl 或 Pod 终端会话进行安全复盘。\n\n## 会话信息\n- 会话ID: {{sessionId}}\n- 操作人: {{operator}}\n- 目标类型: {{targetType}}\n- 目标名称: {{targetName}}\n- 会话时长: {{sessionDuration}}\n- 来源IP: {{sourceIp}}\n\n## 审计数据\n- 命令清单: {{commands}}\n- 高风险命令: {{riskCommands}}\n- 输出摘要: {{outputSummary}}\n- 关联工单/变更: {{changeTicket}}\n\n## 输出要求\n1. 判断本次会话属于“合规 / 可疑 / 高风险”。\n2. 列出关键命令时间线，说明每一步目的。\n3. 对 rm、truncate、drop、kill、kubectl delete、kubectl exec、证书替换等动作给出风险点评。\n4. 说明是否需要补录工单、变更单、回滚记录或录像留档。\n5. 给出审计结论和后续整改建议。', '["sessionId","operator","targetType","targetName","sessionDuration","sourceIp","commands","riskCommands","outputSummary","changeTicket"]', '你是 OpsNexus 的审计与合规助手，擅长复盘终端操作、识别高风险命令并输出可追责的审计结论。', 0.15, 1800, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
INSERT INTO `prompt_template` VALUES (7, 'yaml_change_review', 'general', 'analysis', '你是 OpsNexus 的发布与 YAML 变更评审助手，请在执行 kubectl apply、server-side apply、回滚或配置变更前，对本次变更进行风险审查。\n\n## 变更上下文\n- 集群: {{clusterName}}\n- 命名空间: {{namespace}}\n- 资源类型: {{resourceKind}}\n- 资源名称: {{resourceName}}\n- 变更人: {{operator}}\n- 变更目的: {{changeReason}}\n\n## 变更内容\n- 差异摘要: {{diffSummary}}\n- 当前 YAML: {{currentYaml}}\n- 目标 YAML: {{desiredYaml}}\n\n## 输出要求\n1. 概述本次变更影响的对象、字段和风险点。\n2. 判断是否建议先执行 dry-run、灰度、分批发布或先扩容再变更。\n3. 识别高风险修改，如镜像、探针、资源限制、PVC、Service、Ingress、Secret、ConfigMap、RBAC、HPA。\n4. 给出上线前检查清单、上线后验证清单和回滚方案。\n5. 最后给出一个结论：允许变更 / 谨慎变更 / 暂不建议变更，并说明理由。', '["clusterName","namespace","resourceKind","resourceName","operator","changeReason","diffSummary","currentYaml","desiredYaml"]', '你是 OpsNexus 的配置变更评审助手，擅长在 YAML 变更、扩缩容和发布前识别平台风险并给出验证与回滚建议。', 0.20, 1800, 0, 1, '2026-03-18 20:00:00.000', '2026-03-18 20:00:00.000');
-- ----------------------------
...
-- ----------------------------
INSERT INTO `quick_deployment_tasks` VALUES (45, 35, 20, 's3-api', 's3-api', 'test', 55, '', 20, 3, 1, '2026-01-19 16:02:18.592', '2026-01-19 16:04:09.463', 110, '', 'http://203.0.113.10:8080/job/s3-api/20/console', '2026-01-19 16:01:22.577', '2026-01-19 16:04:09.521', '{\"commit_id\":\"123456\",\"env\":\"test\"}');
INSERT INTO `quick_deployment_tasks` VALUES (47, 37, 20, 's3-api', 's3-api', 'test', 55, '', 21, 3, 1, '2026-01-19 17:06:09.374', '2026-01-19 17:07:59.962', 110, '', 'http://203.0.113.10:8080/job/s3-api/21/console', '2026-01-19 17:02:10.420', '2026-01-19 17:08:00.013', '{\"commit_id\":\"123456\",\"env\":\"test\"}');
INSERT INTO `quick_deployment_tasks` VALUES (48, 37, 21, 's3-web', 's3-web', 'test', 58, '', 11, 3, 2, '2026-01-19 17:08:00.497', '2026-01-19 17:08:23.232', 22, '', 'http://203.0.113.10:8080/job/s3-web/11/console', '2026-01-19 17:02:10.834', '2026-01-19 17:08:23.284', '{\"commit_id\":\"123456\"}');
INSERT INTO `quick_deployment_tasks` VALUES (49, 38, 21, 's3-web', 's3-web', 'test', 58, '', 12, 3, 1, '2026-01-19 17:17:55.822', '2026-01-19 17:18:18.456', 22, '', 'http://203.0.113.10:8080/job/s3-web/12/console', '2026-01-19 17:16:38.433', '2026-01-19 17:18:18.506', '{\"commit_id\":\"123456\"}');
INSERT INTO `quick_deployment_tasks` VALUES (50, 39, 20, 's3-api', 's3-api', 'test', 55, '', 22, 3, 1, '2026-01-19 17:20:12.789', '2026-01-19 17:22:05.410', 112, '', 'http://203.0.113.10:8080/job/s3-api/22/console', '2026-01-19 17:19:50.088', '2026-01-19 17:22:05.460', '{\"commit_id\":\"123456\",\"env\":\"test\"}');
INSERT INTO `quick_deployment_tasks` VALUES (51, 39, 21, 's3-web', 's3-web', 'test', 58, '', 13, 3, 2, '2026-01-19 17:20:22.426', '2026-01-19 17:20:42.601', 20, '', 'http://203.0.113.10:8080/job/s3-web/13/console', '2026-01-19 17:19:50.510', '2026-01-19 17:20:42.652', '{\"commit_id\":\"123456\"}');
...
-- ----------------------------
INSERT INTO `sys_admin` VALUES (89, 1, 15, 'admin', 'c7f1c691035e5cf529090a03ba8d293e', '管理员', 'http://203.0.113.10:8080/api/v1/upload/avatar/20260119/109120000.svg', 'redacted@example.com', '13800000000', '后端研发', '2023-05-23 22:15:50', 1);
INSERT INTO `sys_admin` VALUES (102, 12, 14, 'test', 'e10adc3949ba59abbe56e057f20f883e', '游客', 'http://203.0.113.10:8080/api/v1/upload/avatar/20260116/582307000.png', 'redacted@example.com', '13800000000', '游客', '2025-09-24 12:49:06', 1);
INSERT INTO `sys_admin` VALUES (105, 1, 1, 'zhangfan', 'e10adc3949ba59abbe56e057f20f883e', '张帆', 'http://203.0.113.10:8080/api/v1/upload/avatar/20260116/71921000.png', 'redacted@example.com', '13800000000', '123', '2025-12-09 14:46:54', 1);
INSERT INTO `sys_admin` VALUES (106, 10, 5, 'lisi', 'e10adc3949ba59abbe56e057f20f883e', '李四', 'http://203.0.113.10:8080/api/v1/upload/avatar/20260116/746833000.svg', '123', '123', '123', '2025-12-15 23:44:12', 1);
INSERT INTO `sys_admin` VALUES (107, 12, 6, 'wangwu', 'e10adc3949ba59abbe56e057f20f883e', '王五', 'http://203.0.113.10:8080/api/v1/upload/avatar/20260119/294685000.png', '123', '123', '123', '2025-12-15 23:46:10', 1);
...
INSERT INTO `sys_command_audit` VALUES (87, 28, '1768316317_e6f89da89f84cd77', 'cp AutoOps.conf example.com.conf[H[mv', 361.454342189, 18, 0, 0, '', '2026-01-13 23:04:39.244', '2026-01-14 00:17:42.789');
...
INSERT INTO `sys_command_audit` VALUES (89, 28, '1768316317_e6f89da89f84cd77', 'cp example.com.conf example.com.conf [D[D[D[D[Dai', 377.850451932, 20, 0, 0, '', '2026-01-13 23:04:55.640', '2026-01-14 00:17:42.789');
...
INSERT INTO `sys_command_audit` VALUES (93, 28, '1768316317_e6f89da89f84cd77', 'vim example.com.conf', 405.561509876, 24, 0, 0, '', '2026-01-13 23:05:23.352', '2026-01-14 00:17:42.790');
...
INSERT INTO `sys_command_audit` VALUES (100, 28, '1768316317_e6f89da89f84cd77', 'vim example.com.conf', 537.99637449, 31, 0, 0, '', '2026-01-13 23:07:35.786', '2026-01-14 00:17:42.790');
...
INSERT INTO `sys_command_audit` VALUES (102, 28, '1768316317_e6f89da89f84cd77', 'curl [200~http://203.0.113.10:3000/[201~[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D[D-I', 589.133205987, 33, 1, 1, '包含敏感操作关键词', '2026-01-13 23:08:26.923', '2026-01-14 00:17:42.791');
INSERT INTO `sys_command_audit` VALUES (103, 28, '1768316317_e6f89da89f84cd77', '[200~example.com[201~[D[D[D[D[D[D[D[D[D[Dhttps://[C[C[C[C[C[C[C[C[C[C[C/ai', 627.358534052, 34, 0, 0, '', '2026-01-13 23:09:05.149', '2026-01-14 00:17:42.791');
...
INSERT INTO `sys_command_audit` VALUES (107, 28, '1768316317_e6f89da89f84cd77', 'cat example.com.conf', 1092.844349049, 38, 0, 0, '', '2026-01-13 23:16:50.634', '2026-01-14 00:17:42.792');
...
INSERT INTO `sys_command_audit` VALUES (109, 28, '1768316317_e6f89da89f84cd77', 'vim example.com.conf', 1200.220537001, 40, 0, 0, '', '2026-01-13 23:18:38.011', '2026-01-14 00:17:42.792');
...
INSERT INTO `sys_command_audit` VALUES (112, 28, '1768316317_e6f89da89f84cd77', '[I[2;2R[3;1R[>0;276;0c]10;rgb:d4d4/d4d4/d4d4\\]11;rgb:1e1e/1e1e/1e1e\\[?12;2$ygg1000dda[200~# HTTPS  for example.com', 1629.034815126, 43, 1, 1, '包含敏感操作关键词', '2026-01-13 23:25:46.825', '2026-01-14 00:17:42.793');
...
INSERT INTO `sys_command_audit` VALUES (115, 28, '1768316317_e6f89da89f84cd77', 'curl  [200~curl -v http://203.0.113.10:3000/api/user_group_map[201~[200~curl -v http://203.0.113.10:3000/api/user_group_map[201~', 2712.849749575, 46, 1, 1, '包含敏感操作关键词', '2026-01-13 23:43:50.640', '2026-01-14 00:17:42.793');
...
INSERT INTO `sys_command_audit` VALUES (118, 28, '1768316317_e6f89da89f84cd77', '[200~curl -H \"Host: example.com\" http://203.0.113.10/api/user_group_map[201~', 2790.05621414, 49, 1, 1, '包含敏感操作关键词', '2026-01-13 23:45:07.846', '2026-01-14 00:17:42.794');
INSERT INTO `sys_command_audit` VALUES (119, 28, '1768316317_e6f89da89f84cd77', '[200~curl -k -H \"Host: example.com\" https://203.0.113.10/api/user_group_map[201~', 2808.365654357, 50, 1, 1, '包含敏感操作关键词', '2026-01-13 23:45:26.156', '2026-01-14 00:17:42.794');
...
INSERT INTO `sys_command_audit` VALUES (121, 28, '1768316317_e6f89da89f84cd77', 'cat example.com.conf', 2952.770165855, 52, 0, 0, '', '2026-01-13 23:47:50.560', '2026-01-14 00:17:42.794');
...
INSERT INTO `sys_command_audit` VALUES (123, 28, '1768316317_e6f89da89f84cd77', 'vim  example.com.conf', 3013.770884208, 54, 0, 0, '', '2026-01-13 23:48:51.561', '2026-01-14 00:17:42.794');
INSERT INTO `sys_command_audit` VALUES (124, 28, '1768316317_e6f89da89f84cd77', '[200~grep \"proxy_set_header Host\" /etc/nginx/conf.d/example.com.conf[201~', 3114.316680585, 55, 0, 0, '', '2026-01-13 23:50:32.107', '2026-01-14 00:17:42.794');
...
INSERT INTO `sys_command_audit` VALUES (127, 28, '1768316317_e6f89da89f84cd77', 'cp example.com.conf example.com.bak', 3573.075438903, 58, 0, 0, '', '2026-01-13 23:58:10.865', '2026-01-14 00:17:42.795');
...
INSERT INTO `sys_command_audit` VALUES (129, 28, '1768316317_e6f89da89f84cd77', 'vim example.com.conf', 3581.144246876, 60, 0, 0, '', '2026-01-13 23:58:18.934', '2026-01-14 00:17:42.795');
...
-- ----------------------------
INSERT INTO `sys_operation_log` VALUES (1, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/sysOperationLog/clean', '2026-01-19 18:04:21.698', '清空');
INSERT INTO `sys_operation_log` VALUES (2, 89, 'admin', 'post', '203.0.113.10', '/api/v1/config/accountauth/decrypt', '2026-01-19 19:18:04.092', '');
INSERT INTO `sys_operation_log` VALUES (3, 89, 'admin', 'post', '203.0.113.10', '/api/v1/monitor/alert-sources', '2026-01-19 19:32:39.044', '');
INSERT INTO `sys_operation_log` VALUES (4, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/monitor/alert-sources/7', '2026-01-19 19:33:16.728', '');
INSERT INTO `sys_operation_log` VALUES (5, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/monitor/incident/3', '2026-01-19 19:35:56.626', '删除故障记录');
INSERT INTO `sys_operation_log` VALUES (6, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/monitor/incident/6', '2026-01-19 19:36:00.006', '删除故障记录');
INSERT INTO `sys_operation_log` VALUES (7, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/monitor/incident/5', '2026-01-19 19:36:22.489', '删除故障记录');
INSERT INTO `sys_operation_log` VALUES (8, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/monitor/incident/1', '2026-01-19 19:36:27.867', '删除故障记录');
INSERT INTO `sys_operation_log` VALUES (9, 89, 'admin', 'delete', '203.0.113.10', '/api/v1/monitor/incident/2', '2026-01-19 19:36:33.768', '删除故障记录');
INSERT INTO `sys_operation_log` VALUES (10, 89, 'admin', 'put', '203.0.113.10', '/api/v1/monitor/incident', '2026-01-19 19:36:50.575', '更新故障记录');
INSERT INTO `sys_operation_log` VALUES (11, 89, 'admin', 'put', '203.0.113.10', '/api/v1/monitor/incident', '2026-01-19 19:36:54.333', '更新故障记录');
...
INSERT INTO `sys_menu` (`id`,`parent_id`,`menu_name`,`icon`,`value`,`menu_type`,`url`,`menu_status`,`sort`,`create_time`) VALUES
(254,0,'统一搜索','Search','',1,'',2,10,'2026-03-20 10:30:00'),
(255,254,'全局搜索','Search','search:global',2,'search/global',2,1,'2026-03-20 10:30:01'),
(256,44,'告警中心','Bell','monitor:alert:center',2,'monitor/alert-center',2,5,'2026-03-20 10:30:02'),
(257,44,'告警推送','Promotion','monitor:alert:notify',2,'monitor/alert-notify',2,6,'2026-03-20 10:30:03'),
(258,44,'告警历史','Histogram','monitor:alert:history',2,'monitor/alert-history',2,7,'2026-03-20 10:30:04'),
(259,84,'LDAP 集成','Lock','config:ldap',2,'config/ldap',2,4,'2026-03-20 10:30:05'),
(260,81,'监控仪表盘','Monitor','k8s:monitoring',2,'k8s/monitoring',2,8,'2026-03-20 10:30:06')
ON DUPLICATE KEY UPDATE `menu_name` = VALUES(`menu_name`), `icon` = VALUES(`icon`), `value` = VALUES(`value`), `menu_type` = VALUES(`menu_type`), `url` = VALUES(`url`), `menu_status` = VALUES(`menu_status`), `sort` = VALUES(`sort`);

INSERT INTO `sys_role_menu` (`role_id`,`menu_id`) VALUES
(1,254),(1,255),(1,256),(1,257),(1,258),(1,259),(1,260),
(13,254),(13,255),(13,256),(13,257),(13,258),(13,260)
ON DUPLICATE KEY UPDATE `menu_id` = VALUES(`menu_id`);

-- 2026-03-21 current route menu sync
INSERT INTO `sys_menu` (`id`,`parent_id`,`menu_name`,`icon`,`value`,`menu_type`,`url`,`menu_status`,`sort`,`create_time`) VALUES
(247,44,'会话录制','Coin','monitor:recording',2,'monitor/recording',2,4,'2026-01-08 19:57:24'),
(254,0,'统一搜索','Search','',1,'',2,10,'2026-03-20 10:30:00'),
(255,254,'全局搜索','Search','search:global',2,'search/global',2,1,'2026-03-20 10:30:01'),
(256,44,'告警中心','Bell','monitor:alert:center',2,'monitor/alert-center',2,5,'2026-03-20 10:30:02'),
(257,44,'告警推送','Promotion','monitor:alert:notify',2,'monitor/alert-notify',2,6,'2026-03-20 10:30:03'),
...
(259,84,'LDAP 集成','Lock','config:ldap',2,'config/ldap',2,4,'2026-03-20 10:30:05'),
(260,81,'监控仪表盘','Monitor','k8s:monitoring',2,'k8s/monitoring',2,8,'2026-03-20 10:30:06'),
(261,44,'监控深化','Monitor','monitor:workbench',2,'monitor/https',2,8,'2026-03-21 16:05:10'),
(262,0,'工单中心','Tickets','',1,'',2,11,'2026-03-21 16:05:11'),
(263,262,'工单列表','Tickets','work:order:list',2,'work/orders',2,1,'2026-03-21 16:05:12'),
(264,262,'工单申请','CirclePlus','work:order:apply',2,'work/apply',2,2,'2026-03-21 16:05:13'),
(265,0,'知识库','Reading','',1,'',2,12,'2026-03-21 16:05:14'),
(266,265,'知识文章','Reading','knowledge:article:list',2,'knowledge/base',2,1,'2026-03-21 16:05:15'),
(267,101,'AI 诊断','MagicStick','ai:diagnosis',2,'ai/diagnosis',2,3,'2026-03-21 16:05:16'),
(268,80,'SQL工单','Tickets','cmdb:sql:work-orders',2,'cmdb/sql-work-orders',2,4,'2026-03-21 16:05:17'),
(269,97,'配置管理','Setting','task:config',2,'task/config',2,4,'2026-03-21 16:05:18')
ON DUPLICATE KEY UPDATE `parent_id` = VALUES(`parent_id`), `menu_name` = VALUES(`menu_name`), `icon` = VALUES(`icon`), `value` = VALUES(`value`), `menu_type` = VALUES(`menu_type`), `url` = VALUES(`url`), `menu_status` = VALUES(`menu_status`), `sort` = VALUES(`sort`);

INSERT INTO `sys_role_menu` (`role_id`,`menu_id`) VALUES
(1,247),(1,254),(1,255),(1,256),(1,257),(1,258),(1,259),(1,260),(1,261),(1,262),(1,263),(1,264),(1,265),(1,266),(1,267),(1,268),(1,269),
(13,247),(13,254),(13,255),(13,256),(13,257),(13,258),(13,259),(13,260),(13,261),(13,262),(13,263),(13,264),(13,265),(13,266),(13,267),(13,268),(13,269)
ON DUPLICATE KEY UPDATE `menu_id` = VALUES(`menu_id`);
