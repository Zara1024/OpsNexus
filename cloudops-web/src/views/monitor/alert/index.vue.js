...
import { ackAlertApi, listActiveAlertsApi, silenceAlertApi } from '@/api/monitor';
...
__VLS_32.slots.default;
{
    ...
    const __VLS_40 = {
        onClick: (...[$event]) => {
            __VLS_ctx.handleAck(scope.row.id);
        }
    };
    __VLS_asFunctionalDirective(__VLS_directives.vPermission)(null, { ...__VLS_directiveBindingRestFields, value: ('monitor:alert:ack') }, null, null);
    ...
    const __VLS_48 = {
        onClick: (...[$event]) => {
            __VLS_ctx.handleSilence(scope.row.id);
        }
    };
    __VLS_asFunctionalDirective(__VLS_directives.vPermission)(null, { ...__VLS_directiveBindingRestFields, value: ('monitor:alert:silence') }, null, null);
