...
import { deletePodApi, getPodLogsApi, listK8sClustersApi, listK8sNamespacesApi, listPodsApi } from '@/api/k8s';
...
__VLS_48.slots.default;
{
    ...
    const __VLS_56 = {
        onClick: (...[$event]) => {
            __VLS_ctx.showLogs(scope.row.metadata?.name);
        }
    };
    __VLS_asFunctionalDirective(__VLS_directives.vPermission)(null, { ...__VLS_directiveBindingRestFields, value: ('k8s:workload:pod:log') }, null, null);
    ...
    __VLS_asFunctionalDirective(__VLS_directives.vPermission)(null, { ...__VLS_directiveBindingRestFields, value: ('k8s:workload:pod:delete') }, null, null);
