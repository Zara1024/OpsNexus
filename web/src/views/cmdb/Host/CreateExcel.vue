...
export default {
  ...
  methods: {
    resolveDownloadFileName(headers = {}) {
    ...
    async downloadTemplate() {
      ...
      try {
        ...
        const fileName = this.resolveDownloadFileName(response.headers)
        ...
        this.$message.error(error?.response?.data?.message || '模板下载失败')
      } finally {
