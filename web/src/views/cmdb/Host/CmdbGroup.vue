      ...
      <div class="card-header">
        <div class="title-wrapper">
          ...
          <div class="title-content">
            ...
            <span class="group-card__subtitle">Asset Groups</span>
          </div>
        </div>
...
/* 🎨 高科技卡片设计 */
.group-card {
  background: linear-gradient(145deg, rgba(13, 24, 41, 0.98), rgba(9, 18, 32, 0.94));
...
.tech-input :deep(.el-input__wrapper):hover {
  border-color: rgba(53, 164, 255, 0.28);
...
.toggle-btn {
  ...
  box-shadow: 0 10px 18px rgba(2, 8, 23, 0.3);
  z-index: 10;
}
