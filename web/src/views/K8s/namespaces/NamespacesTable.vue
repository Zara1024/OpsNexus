...
.quota-badge :deep(.el-tag),
.limit-badge :deep(.el-tag) {
  min-width: 56px;
  min-height: 26px;
...
.quota-badge :deep(.el-tag) {
  background: linear-gradient(135deg, rgba(245, 158, 11, 0.24), rgba(217, 119, 6, 0.16)) !important;
...
.quota-badge :deep(.el-badge__content),
.limit-badge :deep(.el-badge__content) {
  min-width: 22px;
  height: 22px;
  line-height: 22px;
  font-size: 11px;
