...
const applyServiceTableLayout = () => {
  nextTick(() => {
    document.querySelectorAll('.resource-table .el-table__header-wrapper table, .resource-table .el-table__body-wrapper table').forEach(table => {
      ...
      <div class="table-content">
        ...
        <div v-if="activeTab === 'service'" class="tab-content">
          ...
          >
              ...
              <el-table-column label="选择器" min-width="120">
                <template #default="{ row }">
...
.resource-table :deep(.el-table__header table),
.resource-table :deep(.el-table__body table) {
  width: 980px !important;
  max-width: 980px !important;
  table-layout: fixed !important;
}

.resource-table :deep(.el-table__header-wrapper th:nth-child(3)),
.resource-table :deep(.el-table__body-wrapper td:nth-child(3)),
.resource-table :deep(.el-table__header-wrapper th:nth-child(5)),
.resource-table :deep(.el-table__body-wrapper td:nth-child(5)),
.resource-table :deep(.el-table__header-wrapper th:nth-child(6)),
.resource-table :deep(.el-table__body-wrapper td:nth-child(6)) {
  display: none !important;
}

.resource-table :deep(.el-table__fixed-right) {
  width: 240px !important;
}

.resource-table :deep(.el-table__fixed-right colgroup col),
.resource-table :deep(.el-table__fixed-right .el-table__cell) {
  width: 240px !important;
