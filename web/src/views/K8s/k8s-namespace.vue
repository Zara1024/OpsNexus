...
.create-limit-range-dialog :deep(.el-form-item) {
  margin-bottom: 18px;
}

.create-limit-range-dialog :deep(.el-input-group__append) {
  min-width: 56px;
  justify-content: center;
}

.create-limit-range-dialog :deep(.el-input__inner::placeholder) {
  font-size: 12px;
  letter-spacing: 0;
}

.create-limit-range-dialog :deep(.el-input__wrapper) {
  min-height: 40px;
}
