...
metadata:
  ...
  labels:${Object.keys(cleanedYaml.metadata.labels || {}).length > 0 ? 
    ...
    '\n    # No labels'}
spec:
  containers:${cleanedYaml.spec.containers.map((container) => `
  - name: ${container.name}
        ...
        <el-tabs v-model="activeTab" type="border-card" @tab-change="handleTabChange">
          ...
          <el-tab-pane label="容器组" name="containers">
            ...
            >
              ...
              <el-table-column prop="nodeName" label="节点" min-width="120"></el-table-column>
              
              <el-table-column prop="podIP" label="Pod IP" min-width="110"></el-table-column>
