  ...
  <div class="cluster-table-container">
    ...
    <div class="table-section">
      ...
      >
        ...
        <el-table-column prop="version" label="集群版本" min-width="120">
          <template #default="{ row }">
        ...
        <el-table-column prop="nodeCount" label="节点数量" min-width="92">
          <template #default="{ row }">
        ...
        <el-table-column prop="status" label="集群状态" min-width="92">
          <template #default="{ row }">
            <el-tag
        ...
        <el-table-column prop="description" label="备注信息" min-width="140">
          <template #default="{ row }">
