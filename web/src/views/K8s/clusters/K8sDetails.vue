      ...
      <div class="details-sections">
        ...
        <el-card class="nodes-card" shadow="hover">
          ...
          <el-table 
            ...
            max-height="300"
          >
            <el-table-column prop="name" label="节点名称" width="170" show-overflow-tooltip />
            ...
            <el-table-column prop="externalIP" label="外部IP" width="100" />
            <el-table-column prop="version" label="K8s版本" width="110" />
            <el-table-column prop="osImage" label="操作系统" width="160" show-overflow-tooltip />
...
const openKubectlTerminal = () => {
  router.push(`/k8s/kubectl/${clusterId.value}`)
}
...
.events-table :deep(.cell.el-tooltip) {
  white-space: normal;
