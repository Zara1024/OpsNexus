<template>
  <div class="ansible-flow-container" style="margin-top: -5px !important; top: -5px !important;">
    <div class="flow-header">
      <el-button v-if="!historyMode" v-authority="['task:ansible:jobstart']" @click="startAnsibleTask" type="primary" size="default" style="height: 40px; padding: 0 20px;" :loading="starting">
        <el-icon size="20"><VideoPlay /></el-icon>
        <span style="margin-left: 8px;">启动任务</span>
      </el-button>
      <el-button @click="handleRefresh" type="info" size="default" style="height: 40px; padding: 0 20px;">
...
<script>
import { StartAnsibleTaskFlow, GetAnsibleTaskDetail, GetAnsibleHistoryDetail } from '@/api/task'
