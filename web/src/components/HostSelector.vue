<template>
  ...
  >
    <div class="host-selector-layout">
      <!-- 左侧分组树 -->
      <div class="host-selector-tree-panel">
      ...
      <!-- 右侧主机表格 -->
      <div class="host-selector-table-panel">
          ...
          >
            <template #default="{row}">
              <div class="host-cell" v-if="row.publicIp">
                <el-icon class="public-ip-icon"><Position /></el-icon>
