...
const normalizeWorkloadType = (workloadType = '') => {
    const normalized = String(workloadType).toLowerCase()
    const typeMap = {
...
export default {
    ...
    getWorkloadAutoscaling(clusterId, namespaceName, workloadType, workloadName) {
        const normalizedType = normalizeWorkloadType(workloadType)
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/workloads/${normalizedType}/${workloadName}/autoscaling`,
            method: 'get'
        })
    },

    getWorkloadCapacitySuggestion(clusterId, namespaceName, workloadType, workloadName) {
        const normalizedType = normalizeWorkloadType(workloadType)
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/workloads/${normalizedType}/${workloadName}/capacity-suggestion`,
            method: 'get'
        })
    },

    getWorkloadGovernanceOverview(clusterId, namespaceName, workloadType, workloadName) {
        const normalizedType = normalizeWorkloadType(workloadType)
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/workloads/${normalizedType}/${workloadName}/governance-overview`,
            method: 'get'
        })
    },

    getWorkloadCapacitySuggestionHistory(clusterId, namespaceName, workloadType, workloadName, params) {
        const normalizedType = normalizeWorkloadType(workloadType)
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/workloads/${normalizedType}/${workloadName}/capacity-suggestion/history`,
            method: 'get',
            params
        })
    },

    upsertWorkloadAutoscaling(clusterId, namespaceName, workloadType, workloadName, data) {
        const normalizedType = normalizeWorkloadType(workloadType)
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/workloads/${normalizedType}/${workloadName}/autoscaling`,
            method: 'put',
    ...
    deleteWorkloadAutoscaling(clusterId, namespaceName, workloadType, workloadName) {
        const normalizedType = normalizeWorkloadType(workloadType)
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/workloads/${normalizedType}/${workloadName}/autoscaling`,
            method: 'delete'
    ...
    // 更新工作负载YAML
    updateWorkloadYaml(clusterId, namespaceName, workloadType, workloadName, yamlContent, options = {}) {
        ...
        return request({
            ...
            data: {
                ...
                validateOnly: normalizedOptions.validateOnly === true,
    ...
    // 通过kubectl apply更新资源
    applyYaml(clusterId, yamlContent, options = {}) {
        return request({
    ...
    createStatefulSet(clusterId, namespaceName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/statefulsets`,
            method: 'post',
            data: data
        })
    },

    updateStatefulSet(clusterId, namespaceName, statefulSetName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/statefulsets/${statefulSetName}`,
            method: 'put',
            data: data
        })
    },

    deleteStatefulSet(clusterId, namespaceName, statefulSetName) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/statefulsets/${statefulSetName}`,
            method: 'delete'
        })
    ...
    scaleStatefulSet(clusterId, namespaceName, statefulSetName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/statefulsets/${statefulSetName}/scale`,
            method: 'post',
            data: data
        })
    },

    restartStatefulSet(clusterId, namespaceName, statefulSetName) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/statefulsets/${statefulSetName}/restart`,
            method: 'post'
        })
    },

    createDaemonSet(clusterId, namespaceName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/daemonsets`,
            method: 'post',
            data: data
        })
    },

    updateDaemonSet(clusterId, namespaceName, daemonSetName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/daemonsets/${daemonSetName}`,
            method: 'put',
            data: data
        })
    },

    deleteDaemonSet(clusterId, namespaceName, daemonSetName) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/daemonsets/${daemonSetName}`,
            method: 'delete'
        })
    ...
    restartDaemonSet(clusterId, namespaceName, daemonSetName) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/daemonsets/${daemonSetName}/restart`,
            method: 'post'
        })
    },

    createJob(clusterId, namespaceName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/jobs`,
            method: 'post',
            data: data
        })
    },

    updateJob(clusterId, namespaceName, jobName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/jobs/${jobName}`,
            method: 'put',
            data: data
        })
    },

    deleteJob(clusterId, namespaceName, jobName) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/jobs/${jobName}`,
            method: 'delete'
        })
    ...
    createCronJob(clusterId, namespaceName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/cronjobs`,
            method: 'post',
            data: data
        })
    },

    updateCronJob(clusterId, namespaceName, cronJobName, data) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/cronjobs/${cronJobName}`,
            method: 'put',
            data: data
        })
    },

    deleteCronJob(clusterId, namespaceName, cronJobName) {
        return request({
            url: `/api/v1/k8s/cluster/${clusterId}/namespaces/${namespaceName}/cronjobs/${cronJobName}`,
            method: 'delete'
        })
    ...
    deleteWorkloadByType(clusterId, namespaceName, workloadType, workloadName) {
        switch (normalizeWorkloadType(workloadType)) {
            case 'deployment':
                return this.deleteDeployment(clusterId, namespaceName, workloadName)
            case 'statefulset':
                return this.deleteStatefulSet(clusterId, namespaceName, workloadName)
            case 'daemonset':
                return this.deleteDaemonSet(clusterId, namespaceName, workloadName)
            case 'job':
                return this.deleteJob(clusterId, namespaceName, workloadName)
            case 'cronjob':
                return this.deleteCronJob(clusterId, namespaceName, workloadName)
            case 'pod':
                return this.deletePod(clusterId, namespaceName, workloadName)
            default:
                return Promise.reject(new Error(`Unsupported workload delete operation: ${workloadType}`))
        }
    },

    scaleWorkload(clusterId, namespaceName, workloadType, workloadName, data) {
        switch (normalizeWorkloadType(workloadType)) {
            case 'deployment':
                return this.scaleDeployment(clusterId, namespaceName, workloadName, data)
            case 'statefulset':
                return this.scaleStatefulSet(clusterId, namespaceName, workloadName, data)
            default:
                return Promise.reject(new Error(`Unsupported workload scale operation: ${workloadType}`))
        }
    },

    restartWorkload(clusterId, namespaceName, workloadType, workloadName) {
        switch (normalizeWorkloadType(workloadType)) {
            case 'deployment':
                return this.restartDeployment(clusterId, namespaceName, workloadName)
            case 'statefulset':
                return this.restartStatefulSet(clusterId, namespaceName, workloadName)
            case 'daemonset':
                return this.restartDaemonSet(clusterId, namespaceName, workloadName)
            default:
                return Promise.reject(new Error(`Unsupported workload restart operation: ${workloadType}`))
        }
    }
}
