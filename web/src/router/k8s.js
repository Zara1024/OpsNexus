...
import k8skubectlterminal from '@/views/K8s/pods/K8S-kubectl-terminal.vue'
...
const routes = [
    ...
    {
        path: '/k8s/kubectl/:clusterId',
        component: k8skubectlterminal,
        props: true,
        meta: {sTitle: '瀹瑰櫒绠＄悊', tTitle: 'kubectl缁堢'}
    },
    {
        path: '/k8s/monitoring',
