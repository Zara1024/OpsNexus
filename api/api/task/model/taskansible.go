...
// TaskAnsible represents an Ansible task definition.
type TaskAnsible struct {
	...
	IsRecurring   int               `gorm:"column:is_recurring;default:0;comment:'是否周期任务'"`
	CronExpr      string            `gorm:"column:cron_expr;size:255;comment:'Cron表达式'"`
	...
	TaskCount     int               `gorm:"not null;default:0;comment:'任务数量'"`
