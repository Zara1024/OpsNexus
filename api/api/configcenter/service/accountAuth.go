...
func (s *AccountAuthService) ListWithPage(page, pageSize int, alias string, accountType *int) ([]model.AccountAuth, int64, error) {
	return s.dao.ListWithPage(page, pageSize, alias, accountType)
}
