...
// @Tags CMDB数据库
// 批量删除SQL操作日志
// @Summary 批量删除SQL操作日志接口
// @Produce json
// @Description 批量删除SQL操作日志接口
// @Param data body model.BatchDeleteCmdbSqlLogDto true "data"
// @Success 200 {object} result.Result
// @router /api/v1/cmdb/sqlLog/batch/delete [delete]
// @Security ApiKeyAuth
func BatchDeleteCmdbSqlLog(c *gin.Context) {
	var dto model.BatchDeleteCmdbSqlLogDto
	_ = c.BindJSON(&dto)
	service.NewCmdbSQLRecordService(dao.NewCmdbSQLRecordDao(common.GetDB())).BatchDeleteCmdbSqlLogByIds(c, dto)
}
